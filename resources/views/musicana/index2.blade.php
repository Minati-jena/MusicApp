                ...
                <div class="container">
                    ...
                    <nav class="classy-navbar justify-content-between" id="oneMusicNav">
                        ...
                        <div class="classy-menu">
                            ...
                            <div class="classynav">
                                <ul>
                                    <li><a href="{{url('/')}}/Themes/index.html">Home</a></li>
                                    <li><a href="{{url('/')}}/Themes/albums-store.html">Albums</a></li>
                                    <li><a href="#">Pages</a>
                                        <ul class="dropdown">
                                            <li><a href="{{url('/')}}/Themes/index.html">Home</a></li>
                                            <li><a href="{{url('/')}}/Themes/albums-store.html">Albums</a></li>
                                            <li><a href="{{url('/')}}/Themes/event.html">Events</a></li>
                                            <li><a href="{{url('/')}}/Themes/blog.html">News</a></li>
                                            <li><a href="{{url('/')}}/Themes/contact.html">Contact</a></li>
                                            <li><a href="{{url('/')}}/Themes/elements.html">Elements</a></li>
                                            <li><a href="{{url('/')}}/Themes/login.html">Login</a></li>
                                ...
                                <div class="login-register-cart-button d-flex align-items-center">
                                    ...
                                    <div class="login-register-btn mr-50">
                                        <a href="{{url('/')}}/Themes/login.html" id="loginBtn">Login / Register</a>
                                    </div>
